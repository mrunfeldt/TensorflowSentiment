...
if False:
    ...
    for i in range(10):
        ax.flat[i].imshow(W_img[:,i].reshape((28,28)),cmap='bwr')
...
print("test accuracy %f"%accuracy.eval(feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0}, session=sess))
